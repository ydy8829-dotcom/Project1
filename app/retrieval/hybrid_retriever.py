...
class HybridRetriever:
    ...
    def __init__(self, documents: list[dict], keyword_weight: float = 0.55, vector_weight: float = 0.45, embedding_client=None):
    ...
    def search(self, query: str, top_k: int = 5) -> list[dict]:
        ...
        if self.embedding_client and self.embedding_client.enabled:
            ...
            document_vectors = self.embedding_client.document_vectors(self.documents)
        ...
        for i, doc in enumerate(self.documents):
            ...
            vector = dense_scores[i] if self.embedding_client and self.embedding_client.enabled else self._vector_score(query, self.term_counts[i])
